<?php $__env->startSection('title', 'Our Services - New Heroes International'); ?>
                ...
                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="service-card bg-white rounded-2xl p-8 shadow-sm hover:shadow-2xl border border-gray-100">
                        ...
                        <div class="service-number mb-4">
                            <?php echo e(str_pad($service->order ?: $index + 1, 2, '0', STR_PAD_LEFT)); ?>
                        ...
                        <p class="text-gray-600 mb-6 leading-relaxed">
                            <?php echo e(Str::limit($service->short_description, 120)); ?>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-wrap gap-4 justify-center">
                <a href="<?php echo e(route('quote')); ?>" class="inline-block px-8 py-4 bg-blue-600 text-white rounded-full font-semibold hover:bg-blue-700 transition-all hover:scale-105">
                    Request a Quote
                </a>
                <a href="<?php echo e(route('contact')); ?>" class="inline-block px-8 py-4 bg-transparent border-2 border-white text-white rounded-full font-semibold hover:bg-white hover:text-gray-900 transition-all">
                    Contact Us
                </a>
            </div>
        </div>
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/Documents/Projects/New_heros/resources/views/web/services/index.blade.php ENDPATH**/ ?>