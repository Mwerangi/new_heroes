...
<body class="bg-gray-100">
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-gray-800 text-white overflow-y-auto">
            ...
            <nav class="p-4">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center px-4 py-3 mb-2 rounded <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-blue-600' : 'hover:bg-gray-700'); ?>">
                ...
                <div class="mb-2">
                    ...
                    <div id="pages-menu" class="ml-4 hidden">
                        <a href="<?php echo e(route('admin.pages.index')); ?>" class="block px-4 py-2 rounded hover:bg-gray-700">All Pages</a>
                    </div>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div id="services-menu" class="ml-4 hidden">
                        <a href="<?php echo e(route('admin.services.index')); ?>" class="block px-4 py-2 rounded hover:bg-gray-700">All Services</a>
                        <a href="<?php echo e(route('admin.services.create')); ?>" class="block px-4 py-2 rounded hover:bg-gray-700">Add Service</a>
                    </div>
                </div>
                
                <!-- Process Steps -->
                <a href="<?php echo e(route('admin.process-steps.index')); ?>" class="flex items-center px-4 py-3 mb-2 rounded hover:bg-gray-700">
                ...
                <div class="mb-2">
                    ...
                    <div id="gallery-menu" class="ml-4 hidden">
                        <a href="<?php echo e(route('admin.galleries.index')); ?>" class="block px-4 py-2 rounded hover:bg-gray-700">All Images</a>
                        <a href="<?php echo e(route('admin.gallery-categories.index')); ?>" class="block px-4 py-2 rounded hover:bg-gray-700">Categories</a>
                    </div>
                </div>
                
                <!-- Testimonials -->
                <a href="<?php echo e(route('admin.testimonials.index')); ?>" class="flex items-center px-4 py-3 mb-2 rounded hover:bg-gray-700">
                ...
                <div class="mb-2">
                    ...
                    <div id="blog-menu" class="ml-4 hidden">
                        <a href="<?php echo e(route('admin.blog-posts.index')); ?>" class="block px-4 py-2 rounded hover:bg-gray-700">All Posts</a>
                        <a href="<?php echo e(route('admin.blog-posts.create')); ?>" class="block px-4 py-2 rounded hover:bg-gray-700">Add Post</a>
                        <a href="<?php echo e(route('admin.blog-categories.index')); ?>" class="block px-4 py-2 rounded hover:bg-gray-700">Categories</a>
                    </div>
                </div>
                
                <!-- Inquiries -->
                <a href="<?php echo e(route('admin.inquiries.index')); ?>" class="flex items-center px-4 py-3 mb-2 rounded hover:bg-gray-700">
                    <i class="fas fa-envelope mr-3"></i> Inquiries
                </a>
                
                <!-- Contact Info -->
                <a href="<?php echo e(route('admin.contact-info.index')); ?>" class="flex items-center px-4 py-3 mb-2 rounded hover:bg-gray-700">
                    <i class="fas fa-address-book mr-3"></i> Contact Info
                </a>
                
                <!-- Downloads -->
                <a href="<?php echo e(route('admin.downloads.index')); ?>" class="flex items-center px-4 py-3 mb-2 rounded hover:bg-gray-700">
                    <i class="fas fa-download mr-3"></i> Downloads
                </a>
                
                <!-- Media Library -->
                <a href="<?php echo e(route('admin.media.index')); ?>" class="flex items-center px-4 py-3 mb-2 rounded hover:bg-gray-700">
                ...
                <div class="mb-2">
                    ...
                    <div id="settings-menu" class="ml-4 hidden">
                        <a href="<?php echo e(route('admin.site-settings.index')); ?>" class="block px-4 py-2 rounded hover:bg-gray-700">Site Settings</a>
                        <a href="<?php echo e(route('admin.seo-settings.index')); ?>" class="block px-4 py-2 rounded hover:bg-gray-700">SEO Settings</a>
                    </div>
                </div>
                
                <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'super-admin')): ?>
                <!-- Users -->
                <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center px-4 py-3 mb-2 rounded hover:bg-gray-700">
                    <i class="fas fa-users mr-3"></i> Users
                </a>
                
                <!-- Activity Logs -->
                <a href="<?php echo e(route('admin.activity-logs.index')); ?>" class="flex items-center px-4 py-3 mb-2 rounded hover:bg-gray-700">
            ...
            <header class="bg-white shadow-sm">
                <div class="flex items-center justify-between p-4">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(route('home')); ?>" target="_blank" class="text-gray-600 hover:text-gray-800">
                        ...
                        <div class="relative">
                            ...
                            <div id="profile-menu" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10">
                                <a href="<?php echo e(route('admin.profile.edit')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
...
<?php /**PATH /Users/macbook/Documents/Projects/New_heros/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>