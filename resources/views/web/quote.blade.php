                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select id="cargo_type" name="cargo_type" required class="w-full px-5 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition bg-white">
                                        ...
                                        <option value="vehicle" {{ old('cargo_type') == 'vehicle' ? 'selected' : '' }}>Motor Vehicle</option>
                                        <option value="heavy_machinery" {{ old('cargo_type') == 'heavy_machinery' ? 'selected' : '' }}>Heavy Machinery</option>
                                        <option value="construction_equipment" {{ old('cargo_type') == 'construction_equipment' ? 'selected' : '' }}>Construction Equipment</option>
                                        <option value="general_cargo" {{ old('cargo_type') == 'general_cargo' ? 'selected' : '' }}>General Cargo</option>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="vehicle_type" name="vehicle_type" value="{{ old('vehicle_type') }}"
                                           class="w-full px-5 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" id="port_of_arrival" name="port_of_arrival" value="{{ old('port_of_arrival', 'Dar es Salaam Port') }}"
                                           class="w-full px-5 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <textarea id="message" name="message" rows="6" required
                                              class="w-full px-5 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                                              placeholder="Please provide any additional details about your cargo, expected arrival date, special handling requirements, or questions you may have...">{{ old('message') }}</textarea>
                                </div>
